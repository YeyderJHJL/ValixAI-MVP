      ...
      <main>
        ...
        <section className="py-12 border-y border-slate-100 bg-white/50 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-6 flex flex-wrap justify-center gap-12 md:gap-24 opacity-50 grayscale">
            <div className="text-2xl font-bold text-slate-400">CONSULTORÍA</div>
            <div className="text-2xl font-bold text-slate-400">ESTRATEGIA</div>
            <div className="text-2xl font-bold text-slate-400">INVERSIÓN</div>
            <div className="text-2xl font-bold text-slate-400">EXPERIENCIA</div>
          </div>
        </section>
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto">
          <div className="text-center mb-20 space-y-4">
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900">¿Cómo funciona ValixAI?</h2>
          ...
          <div className="grid md:grid-cols-12 gap-8">
            <div className="md:col-span-7 bg-white p-12 rounded-[3rem] border border-slate-100 premium-shadow group hover:border-brand-200 transition-all">
              <div className="flex flex-col h-full justify-between">
                <div className="space-y-6">
                  ...
                  <h3 className="text-4xl font-bold text-slate-900">Validación de Mercado Real</h3>
                ...
                <div className="mt-12 grid grid-cols-2 gap-6">
                  <div className="p-6 bg-slate-50 rounded-2xl">
                    ...
                    <div className="text-slate-500 font-medium">Confidencial</div>
                  </div>
                  <div className="p-6 bg-slate-50 rounded-2xl">
                    <div className="text-accent-600 font-bold text-3xl">24/7</div>
                    <div className="text-slate-500 font-medium">Disponibilidad</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-5 space-y-8">
              <div className="bg-brand-900 p-12 rounded-[3rem] text-white premium-shadow relative overflow-hidden group">
                <div className="absolute -right-10 -top-10 w-40 h-40 bg-brand-500/20 rounded-full blur-3xl group-hover:bg-brand-500/40 transition-all" />
                <Rocket size={48} className="text-brand-300 mb-8" />
                <h3 className="text-3xl font-bold mb-4">Roadmap Estratégico</h3>
                <p className="text-xl text-brand-100/80 leading-relaxed">
